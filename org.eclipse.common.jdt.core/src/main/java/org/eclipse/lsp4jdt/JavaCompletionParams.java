...
*     IBM Corporation - convert for common class
*******************************************************************************/
 ...
 * @author datho7561
 */
public class JavaCompletionParams {

	private String uri;
	private Position position;

	public JavaCompletionParams() {

	}

	public JavaCompletionParams(String uri, Position position) {
		this();
		setUri(uri);
