...
*******************************************************************************/
package org.eclipse.lsp4jdt.jdt.core.java.definition;
...
public interface IJavaDefinitionParticipant {
     ...
     */
    default boolean isAdaptedForDefinition(JavaDefinitionContext context, IProgressMonitor monitor) throws CoreException {
        return true;
    }
     ...
     * @throws CoreException
     */
    default void beginDefinition(JavaDefinitionContext context, IProgressMonitor monitor) throws JavaModelException, CoreException {
     ...
     * @throws CoreException
     */
    List<Object> collectDefinitions(JavaDefinitionContext context, IProgressMonitor monitor) throws CoreException;
