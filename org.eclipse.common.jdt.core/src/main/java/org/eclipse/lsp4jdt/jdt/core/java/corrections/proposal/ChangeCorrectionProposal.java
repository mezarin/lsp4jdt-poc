 ...
 *******************************************************************************/
package org.eclipse.lsp4jdt.jdt.core.java.corrections.proposal;
...
import org.eclipse.lsp4jdt.jdt.core.CommonCorePlugin;
        ...
        try {
            ...
            if (change != null) {
                ...
                if (valid.hasFatalError()) {
                    IStatus status = new Status(IStatus.ERROR, CommonCorePlugin.PLUGIN_ID, IStatus.ERROR, valid.getMessageMatchingSeverity(RefactoringStatus.FATAL), null);
