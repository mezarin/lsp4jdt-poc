...
*******************************************************************************/
package org.eclipse.lsp4jdt.jdt.core.java.hover;
...
public interface IJavaHoverParticipant {
     ...
     * @throws CoreException
     */
    default void beginHover(JavaHoverContext context, IProgressMonitor monitor) throws JavaModelException, CoreException {
