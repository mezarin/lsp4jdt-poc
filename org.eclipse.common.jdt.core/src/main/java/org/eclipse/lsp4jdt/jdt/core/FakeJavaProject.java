...
import org.eclipse.lsp4jdt.JavaPropertiesScope;
...
public class FakeJavaProject extends ExternalJavaProject {
	 ...
	 */
	public IJavaElement[] getElementsToSearch(List<JavaPropertiesScope> scopes) throws JavaModelException {
		if (JavaPropertiesScope.isOnlySources(scopes)) {
