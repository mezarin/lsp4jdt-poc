...
*******************************************************************************/
package org.eclipse.lsp4jdt.jdt.core.java.codeaction;
...
import org.eclipse.lsp4jdt.jdt.core.java.ChangeUtil;
import org.eclipse.lsp4jdt.jdt.core.java.corrections.proposal.ChangeCorrectionProposal;
...
public class JavaCodeActionContext extends AbstractJavaContext implements IInvocationContext {
    ...
    private final JavaCodeActionParams params;
    ...
    public JavaCodeActionParams getParams() {
        return params;
    }
