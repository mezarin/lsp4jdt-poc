...
*******************************************************************************/
package org.eclipse.lsp4jdt.jdt.core.java;
...
import org.eclipse.lsp4jdt.jdt.core.operations.java.codeaction.JavaCodeActionDefinition;
...
public class JavaFeaturesRegistry {
     ...
     */
    public List<JavaCodeActionDefinition> getJavaCodeActionDefinitions(String pluginId, String codeActionKind) {
        loadJavaFeatureDefinitions(pluginId);
     ...
     */
    public List<JavaCodeLensDefinition> getJavaCodeLensDefinitions(String pluginId) {
        loadJavaFeatureDefinitions(pluginId);
     ...
     */
    public List<JavaCompletionDefinition> getJavaCompletionDefinitions(String pluginId) {
        loadJavaFeatureDefinitions(pluginId);
     ...
     */
    public List<JavaDefinitionDefinition> getJavaDefinitionDefinitions(String pluginId) {
        loadJavaFeatureDefinitions(pluginId);
     ...
     */
    public List<JavaDiagnosticsDefinition> getJavaDiagnosticsDefinitions(String pluginId) {
        loadJavaFeatureDefinitions(pluginId);
     ...
     */
    public List<JavaHoverDefinition> getJavaHoverDefinitions(String pluginId) {
        loadJavaFeatureDefinitions(pluginId);
     ...
     */
    public List<JavaWorkspaceSymbolsDefinition> getJavaWorkspaceSymbolsDefinitions(String pluginId) {
        loadJavaFeatureDefinitions(pluginId);
        return javaWorkspaceSymbolsDefinitions;
    }

    private synchronized void loadJavaFeatureDefinitions(String pluginId) {
