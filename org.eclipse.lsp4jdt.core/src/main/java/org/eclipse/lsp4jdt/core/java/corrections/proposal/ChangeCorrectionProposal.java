 ...
 *******************************************************************************/
package org.eclipse.lsp4jdt.core.java.corrections.proposal;
        ...
        try {
            ...
            if (change != null) {
                ...
                if (valid.hasFatalError()) {
                    IStatus status = new Status(IStatus.ERROR, LSP4JDTCorePlugin.PLUGIN_ID, IStatus.ERROR, valid.getMessageMatchingSeverity(RefactoringStatus.FATAL), null);
