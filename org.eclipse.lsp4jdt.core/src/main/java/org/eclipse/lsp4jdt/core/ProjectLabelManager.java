...
import org.eclipse.lsp4jdt.participants.core.ProjectLabelRegistry;
...
public class ProjectLabelManager {
    ...
    private ProjectLabelInfoEntry getProjectLabelInfo(IProject project, String pluginId, List<String> types) {
        String uri = LSP4JDTUtils.getProjectURI(project);
        if (uri != null) {
    ...
    private List<String> getProjectLabels(IProject project, String pluginId, List<String> types) {
        ...
        // "org.eclipse.lsp4jdt.jdt.core.projectLabelProviders" extension point (ex
        // : "maven", "gradle", "jakarta", "microprofile").
