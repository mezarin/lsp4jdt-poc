...
*******************************************************************************/
package org.eclipse.lsp4jdt.participants.core.java.validators;
...
import org.eclipse.lsp4jdt.participants.core.java.validators.annotations.AnnotationAttributeRule;
import org.eclipse.lsp4jdt.participants.core.java.validators.annotations.AnnotationRule;
import org.eclipse.lsp4jdt.participants.core.java.validators.annotations.AnnotationRulesJavaASTValidator;
import org.eclipse.lsp4jdt.participants.core.java.validators.annotations.AnnotationValidator;

/**
 * Registry to hold the Extension point
 * "org.eclipse.lsp4jdt.jdt.core.javaASTValidators".
 *
 * @author Angelo ZERR
 *
 */
public class JavaASTValidatorRegistry extends AnnotationValidator implements IRegistryChangeListener {
    ...
    public void registryChanged(final IRegistryChangeEvent event) {
        IExtensionDelta[] deltas = event.getExtensionDeltas(LSP4JDTCorePlugin.PLUGIN_ID, getExtensionId());
        if (deltas != null) {
            synchronized (this) {
...
//					   <extension point="org.eclipse.lsp4jdt.jdt.core.javaASTValidators">
...
//					   </extension>
    ...
    private void addRegistryListenerIfNeeded() {
        ...
        IExtensionRegistry registry = Platform.getExtensionRegistry();
        registry.addRegistryChangeListener(this, LSP4JDTCorePlugin.PLUGIN_ID);
