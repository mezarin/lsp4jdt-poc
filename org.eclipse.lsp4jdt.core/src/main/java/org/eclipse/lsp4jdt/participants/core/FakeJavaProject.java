...
*******************************************************************************/
package org.eclipse.lsp4jdt.participants.core;
...
import org.eclipse.lsp4jdt.commons.PropertiesScope;
...
public class FakeJavaProject extends ExternalJavaProject {
     ...
     */
    public IJavaElement[] getElementsToSearch(List<PropertiesScope> scopes) throws JavaModelException {
        if (PropertiesScope.isOnlySources(scopes)) {
